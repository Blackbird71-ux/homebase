export interface FinanceNavKeyDef {
  key: string
  label: string
  group: 'Day-to-day' | 'Statements' | 'Tax' | 'Subledgers' | 'Detail' | 'Planning' | 'Reference'
}
...
export const FINANCE_NAV_KEYS: FinanceNavKeyDef[] = [
  ...
  { key: 'profitLoss',      label: 'P&L',                group: 'Statements' },
  { key: 'annualPnl',       label: 'Annual P&L',         group: 'Statements' },
  { key: 'balanceSheet',    label: 'Balance Sheet',      group: 'Statements' },
  { key: 'trialBalance',    label: 'Trial Balance / GL', group: 'Statements' },
  { key: 'taxReport',       label: 'Tax Report',         group: 'Tax'        },
  { key: 'bas',             label: 'BAS Worksheet',      group: 'Tax'        },
  { key: 'apAging',         label: 'AP Aging',           group: 'Subledgers' },
  { key: 'arAging',         label: 'AR Aging',           group: 'Subledgers' },
  { key: 'prepayments',     label: 'Prepayments',        group: 'Subledgers' },
  { key: 'journals',        label: 'Journals',           group: 'Detail'     },
  { key: 'vendorStatement', label: 'Statements',         group: 'Detail'     },
  { key: 'reports',         label: 'Reports',            group: 'Detail'     },
  { key: 'insights',        label: 'Insights',           group: 'Detail'     },
...
export const FINANCE_NAV_GROUPS = ['Day-to-day', 'Statements', 'Tax', 'Subledgers', 'Detail', 'Planning', 'Reference'] as const
