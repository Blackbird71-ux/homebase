...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  return (
    <NextThemesProvider
      ...
      themes={['light', 'dark', 'system', 'modern', 'aurora', 'azure', 'midnight', 'apple-grey', 'apple-pro', 'glass-dark', 'sunset', 'ocean', 'forest', 'paper', 'harbour', 'plum', 'high-contrast', 'high-contrast-dark', 'high-contrast-sunset', 'high-contrast-ocean', 'high-contrast-forest', 'high-contrast-midnight', 'apple-aqua', 'apple-graphite', 'apple-sunset', 'apple-midnight', 'apple-forest']}
    >
      <ThemeSyncer>
        {children}
      </ThemeSyncer>
