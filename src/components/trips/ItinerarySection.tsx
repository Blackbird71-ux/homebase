...
export function ItinerarySection({ days, tripId, startDate, endDate, onDaysUpdated }: ItinerarySectionProps) {
  ...
  async function handleSaveActivity(dayId: string, activityId: string, data: {
    title: string; location: string | null; locationLat: number | null; locationLng: number | null; startTime: string | null; endTime: string | null; notes: string | null; category: string | null; showOnCalendar: boolean
  }) {
