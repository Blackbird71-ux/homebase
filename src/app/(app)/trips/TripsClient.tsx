...
import { Plane, Plus, MoreHorizontal, Pencil, Trash2, MapPin, Calendar, Package, CheckCircle2, Clock, AlertTriangle } from 'lucide-react'
...
export function TripsClient({ initialTrips, currentUserId }: TripsClientProps) {
