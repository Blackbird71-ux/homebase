...
export default async function GeneralSettingsPage() {
  ...
  const family = await prisma.family.findUnique({
    ...
    select: { id: true, name: true, timezone: true, loginTagline: true, financeYearStartMonth: true, periodLockedUntil: true },
  })
    ...
    <div className="max-w-lg p-6 flex flex-col gap-6">
      ...
      <FamilySettingsClient
        family={{
          ...
          periodLockedUntil: family?.periodLockedUntil?.toISOString().split('T')[0] ?? null,
        }}
